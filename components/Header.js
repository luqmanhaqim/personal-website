...
const items = [
    { icon: 'fab fa-linkedin', link: 'https://my.linkedin.com/in/luqman-haqim-syahril-azhar' },
    { icon: 'fab fa-github', link: 'https://github.com/luqmanhaqim' },
    { icon: 'fab fa-instagram', link: 'https://www.instagram.com/luqmnhaqim/' },
    { icon: 'fab fa-facebook', link: 'https://www.facebook.com/haqim/?locale=ms_MY' },
    { icon: 'fab fa-tiktok', link: 'https://www.tiktok.com/@haqimazhar?lang=en' },
  ]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">LH</p>
